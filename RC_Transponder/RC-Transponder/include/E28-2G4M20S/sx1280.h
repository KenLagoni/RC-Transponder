...
private:
	...
	RadioOperatingModes_t OperatingModeBeforeSleep;
...
public:
	...
	// function to wake up radio and set opperation mode to the same valie after sleep.
	void SetWakeup( void );
